export default [
  ...
  {
    inputs: [],
    name: 'getInitialSuperFreeSpinWeights',
    outputs: [
      {
        internalType: 'uint16[12][6]',
        name: '',
  ...
  },
  {
    ...
    name: 'getSuperFreeSpinTokenAmount',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'initialSuperFreeSpinWeights',
    outputs: [
      {
        internalType: 'uint16',
        name: '',
  ...
  },
  {
    ...
    name: 'setInitialSuperFreeSpinWeights',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
