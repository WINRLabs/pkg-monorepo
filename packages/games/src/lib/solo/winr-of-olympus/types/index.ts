export enum WinrOfOlympus_Unity_Events {
  BET = "M3_SpinClick",
...
export interface WinrOfOlympusReelSpinSettled {
  betAmount: number;
  scatterCount: number;
  tumbleCount: number;
  ...
  grid: number[][];
  type: "Game";
  spinType: WinrOfOlympusSpinType;
}

export enum WinrOfOlympusSpinType {
  NONE,
  NORMAL_SPIN,
  FREE_SPIN,
  DOUBLE_CHANCE,
...
export interface WinrOfOlympusFormFields {
  betAmount: number;
