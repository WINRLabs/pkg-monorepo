...
import { WinrOfOlympus_Unity_Methods } from "../types";

interface UseUnityOlympusParams {
  buildedGameUrl: string;
  buildedGameUrlMobile: string;
}

export const useUnityOlympus = ({
  buildedGameUrl,
  buildedGameUrlMobile,
}: UseUnityOlympusParams) => {
  ...
  const handleSetBalance = React.useCallback(
    (balance: string) => {
      ...
      sendMessage(
        "WebGLHandler",
        "ReceiveMessage",
        `${WinrOfOlympus_Unity_Methods.SET_CREDIT_VALUE}|${balance}`
      );
    },
    [sendMessage]
  );
  ...
  const handleSpinStatus = React.useCallback(
    (status: "active" | "inactive") => {
      ...
      sendMessage(
        "WebGLHandler",
        "ReceiveMessage",
        `${WinrOfOlympus_Unity_Methods.SET_SPIN_STATUS}|${status === "active"}`
      );
    },
    [sendMessage]
  );
  ...
  const handleSendGrid = React.useCallback(
    (grid: number[][]) => {
      ...
      sendMessage(
        "WebGLHandler",
        "ReceiveMessage",
        `${WinrOfOlympus_Unity_Methods.SEND_GRID}|${_grid}`
      );
    },
    [sendMessage]
  );
  ...
  const handleUpdateWinText = React.useCallback(
    (win: string) => {
      ...
      sendMessage(
        "WebGLHandler",
        "ReceiveMessage",
        `${WinrOfOlympus_Unity_Methods.UPDATE_WIN_TEXT}|${win}`
      );
    },
    [sendMessage]
  );
  ...
  const handleFreespinAmount = React.useCallback(
    (amount: number) => {
      ...
      sendMessage(
        "WebGLHandler",
        "ReceiveMessage",
        `${WinrOfOlympus_Unity_Methods.SET_FREESPIN_AMOUNT}|${amount}`
      );
    },
    [sendMessage]
  );
  ...
  const hideFreeSpinText = React.useCallback(() => {
    ...
    sendMessage(
      "WebGLHandler",
      "ReceiveMessage",
      `${WinrOfOlympus_Unity_Methods.HIDE_FREE_SPIN_COUNT}`
    );
  }, [sendMessage]);
  ...
  const handleUnlockUi = React.useCallback(() => {
    ...
    sendMessage(
      "WebGLHandler",
      "ReceiveMessage",
      WinrOfOlympus_Unity_Methods.UNLOCK_UI
    );
  }, [sendMessage]);
  ...
  const handleEnterFreespin = React.useCallback(() => {
    ...
    sendMessage(
      "WebGLHandler",
      "ReceiveMessage",
      WinrOfOlympus_Unity_Methods.ENTER_FREE_SPIN
    );
  }, [sendMessage]);
  ...
  const handleExitFreespin = React.useCallback(() => {
    ...
    sendMessage(
      "WebGLHandler",
      "ReceiveMessage",
      WinrOfOlympus_Unity_Methods.EXIT_FREE_SPIN
    );
  }, [sendMessage]);
  ...
  const handleLogin = () => {
    ...
    sendMessage(
      "WebGLHandler",
      "ReceiveMessage",
      WinrOfOlympus_Unity_Methods.LOGIN
    );
  };
