...
const log = debug('worker:UseWinrOfOlympus1000Unity');

export const useUnityWinrOfOlympus1000 = ({
  buildedGameUrl,
  buildedGameUrlMobile,
}: UseUnityWinrOfOlympusParams) => {
  const { gameUrl, setGameUrl, prevWidth, setPrevWidth } = useWinrOfOlympus1000GameStore();
  ...
  const {
    ...
    loaderUrl: `${buildedGameUrl}/WinrOfOlympus1000.loader.js`,
    dataUrl: `${buildedGameUrl}/WinrOfOlympus1000.data.unityweb`,
    frameworkUrl: `${buildedGameUrl}/WinrOfOlympus1000.framework.js.unityweb`,
    codeUrl: `${buildedGameUrl}/WinrOfOlympus1000.wasm.unityweb`,
