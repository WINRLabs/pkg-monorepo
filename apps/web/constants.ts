...
export const addresses: Record<NetworkName, Record<NetworkMode, Record<AddressName, Address>>> = {
  winr: {
    ...
    testnet: {
      ...
      crash: '0x7eBc9016D99405176114b397b5a723e3f880aA97',
      ...
      holdemPoker: '0x728278772510622B3C30229460d17B8Fce877DF5',
